...
本文档用于指导你用 **Claude Code 或 Codex**，搭配 **Superpowers** 框架，快速完成 Agora Agents Hackathon 项目 **CopyGuard Bond** 的编码实现。
...
- https://rrtrace.xyz/agents/ 
- 
- 项目二：
- https://github.com/riyannode/ArcLayer
- https://arclayers.xyz/ 
- 
- 项目三：(未公开代码) 
- https://prism-dashboard-production-e6e3.up.railway.app/dashboard 
- https://prism-docs-production.up.railway.app/docs/quickstart 
- 
- 项目四： 
- https://github.com/Artem1981777/CronusCapital
- https://cronus-capital.vercel.app/
- 
- 项目五： 
- https://github.com/Mihai-Codes/rosetta-alpha 
- https://rosetta-alpha.vercel.app/ 
- 
- 项目六：
- https://github.com/MusaAis/agorafx
- https://agorafx.vercel.app/ 
- 
- 项目七：
- https://github.com/KodEx-SA/trading-r1 
- https://trading-r1-trace-market.vercel.app/
- 
# 竞品总排名推断

| 项目               | 技术深度 | Arc/Circle 深度 | Agent 深度 | Traction 证据                                 | 获奖概率 |
| ---------------- | ---- | ------------- | -------- | ------------------------------------------- | ---- |
| ReasoningReceipt | 很高   | 很高            | 很高       | 很高，README 声称 3,000+ receipts / 190+ markets | 很高   |
| ArcLayer         | 很高   | 很高            | 中高       | 中高，协议/console/indexer/tests                 | 很高   |
| Prism            | 很高   | 中高            | 很高       | 中高，CLI/docs/dashboard/receipts              | 高    |
| Rosetta Alpha    | 高    | 中高            | 高        | 未完全验证                                       | 中高   |
| AgoraFX          | 中    | 高             | 中        | 若有真实 market 则不错                             | 中    |
| Trading-R1       | 中    | 中高            | 中        | 看起来较弱                                       | 中低   |
| CronusCapital    | 中低   | 中低            | 中        | 未看到强证据                                      | 中低   |
